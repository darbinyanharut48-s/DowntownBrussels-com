...
const translations = {
  en: {
    ...
    hero_title: 'The Temple of Belgian Beers & Sports Events',
    ...
    feat4_desc: 'Every day from 12:00 to 20:00, the DownTown atmosphere comes alive with our Happy Hour offers! It\'s the perfect time to relax and enjoy discounted prices on a selection of drinks: bottled beers 3 for €12, Spritz & aperitifs 2 for €12, our classic cocktails and mocktails – 1 bought = 1 FREE.',
    ...
    form_select_opt_dinner: 'Dinner Reservation', form_select_opt_sports: 'Sports Night',
    ...
    footer_hours_title: 'Opening Hours', footer_hours: 'Monday to Sunday',
  ...
  fr: {
    ...
    hero_title: 'Le Temple des Bières Belges & Événements Sportifs',
    ...
    feat4_title: 'Happy Hour',
    feat4_desc: 'Tous les jours de 12h à 20h, l\'ambiance DownTown s\'anime avec nos offres Happy Hour ! C\'est le moment idéal pour se détendre et profiter de nos tarifs réduits sur une sélection de boissons : bières en bouteille 3 pour 12 €, Spritz & apéritifs 2 pour 12 €, nos cocktails classiques et mocktails – 1 acheté = 1 OFFERT.',
    ...
    form_select_opt_dinner: 'Réservation Dîner', form_select_opt_sports: 'Soirée Sportive',
    ...
    footer_tagline: 'Le Temple des Bières Belges & Événements Sportifs à Bruxelles.',
    footer_hours_title: 'Heures d\'Ouverture', footer_hours: 'Lundi au Dimanche',
    ...
    loc_tag: 'Nous trouver', loc_title: 'Nous trouver', loc_subtitle: 'Rendez-nous visite au cЕ“ur de Bruxelles.',
  ...
  nl: {
    ...
    feat4_title: 'Happy Hour',
    feat4_desc: 'Elke dag van 12:00 tot 20:00 komt de DownTown-sfeer tot leven met onze Happy Hour-aanbiedingen! Het is het ideale moment om te ontspannen en te profiteren van onze verlaagde prijzen op een selectie dranken: flessenbier 3 voor €12, Spritz & aperitieven 2 voor €12, onze klassieke cocktails en mocktails – 1 gekocht = 1 GRATIS.',
    ...
    form_select_opt_dinner: 'Dinerreservering', form_select_opt_sports: 'Sportavond',
    ...
    loc_addr: 'Henri Mausstraat 15, 1000 Brussel (Beurs)', loc_cta: 'Open in Google Maps',
...
const allMatches = [
  ...
  { competition: 'UEFA Champions League 2026', stage: 'Quarter Finals - 1st leg', home: 'Barcelona', away: 'Atleti', date: '2026-04-08', time: '21:00' },
  { competition: 'UEFA Champions League 2026', stage: 'Quarter Finals - 2nd leg', home: 'Atleti', away: 'Barcelona', date: '2026-04-14', time: '21:00' },
...
const teamLogos = {
  ...
  'Atleti': 'https://crests.football-data.org/78.svg',
  // BPL
